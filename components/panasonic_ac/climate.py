...
CONF_ALTERNATIVE_MILD_DRY_SWITCH = "alternative_mild_dry_switch"
        ...
        CONF_CNT: SCHEMA.extend(
            {
                ...
                cv.Optional(CONF_ALTERNATIVE_MILD_DRY_SWITCH): SWITCH_SCHEMA,
...
async def to_code(config):
    ...
    for s in [CONF_ECO_SWITCH, CONF_NANOEX_SWITCH, CONF_MILD_DRY_SWITCH, CONF_ALTERNATIVE_MILD_DRY_SWITCH, CONF_ECONAVI_SWITCH]:
        if s in config:
            conf = config[s]
